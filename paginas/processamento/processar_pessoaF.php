<div class="row justify-content-md-center">
    ...
    ?>
          ...
          <form action="?pagina=processamento/processar_pessoaF&id_pessoaF=<?= $objFisica->id ?>" method="POST">
              <div class="form-group">
                  <label>Cpf:</label>
                  <input type="text" class="form-control" name="cpf" required placeholder="Digite seu nome" value="<?= $objFisica->cpf ?>" />
              </div>
              <div class="form-group">
                  <label>Nome:</label>
