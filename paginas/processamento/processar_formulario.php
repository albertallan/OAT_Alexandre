<div class="row justify-content-md-center">
    ...
    ?>
          ...
          <form action="?pagina=processamento/processar_formulario&id_contato=<?= $objContato->id ?>" method="POST">
              ...
              <div class="form-group">
                  <label>Texto:</label>
                  <textarea name="texto" class="form-control" required placeholder="Digite sua mensagem..."><?= $objContato->texto ?></textarea>
              </div>
