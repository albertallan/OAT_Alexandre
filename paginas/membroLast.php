<div class="row justify-content-md-center"> 
    <div class="col-8">
            ...
            <h1>Cadastro de Membro da Last:</h1>

            <p>Preencha o formulário de contato abaixo:</p>
            
            <div class="formulario">
                <form action="?pagina=processamento/processar_membroLast" method="POST">
                    ...
                    <div class="form-group">
                        <label>RA:</label>
                        <input type="text" class="form-control" name="ra" required placeholder="Digite seu RA" />
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label>Função:</label>
                        <input type="text" class="form-control" name="funcao" required placeholder="Digite sua função" />
                    </div>                      
